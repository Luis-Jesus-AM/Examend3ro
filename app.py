...
def formulario_y_calculo():
    ...
    if request.method == 'POST':
        try:
            ...
            return render_template("forma.html", error="Por favor, introduce valores numéricos válidos en Peso, Altura y Edad.")
        except Exception:
...
def re():
    ...
    return redirect(url_for('formulario_y_calculo'))
